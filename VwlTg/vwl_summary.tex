...
\section{Wachstum}
\label{sec:org448732a}
\subparagraph{Staatsquote} \
\label{sec:orgfa983da}
...
\label{sec:org31740da}
\subparagraph{Das Makroökonomische Modell} \
\label{sec:orgf701f26}
...
\section{Konjunktur}
\label{sec:org365eec0}
\subparagraph{Phasen Konjunktur} \
\label{sec:org177374e}
\begin{description}
...
\section{Geld}
\label{sec:orgef1d3ba}
\subparagraph{Was ist Geld?} \
\label{sec:org62cd4f1}
...
\label{sec:org260489b}
\subparagraph{Staatseinkommen} \
\label{sec:org6e91966}
...
\label{sec:org609a21f}
\subparagraph{Geschite EU} \
\label{sec:org2a1bd15}
\begin{itemize}
