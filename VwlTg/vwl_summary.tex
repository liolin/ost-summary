...
\section{Wachstum}
\label{sec:org07bedf7}
\subparagraph{Staatsquote} \
\label{sec:orgd590d88}
...
\section{Verteilung}
\label{sec:org6b43ea0}
\subparagraph{Pareto Effizienz} \
\label{sec:org2e45e12}
...
\label{sec:org2877e55}
\subparagraph{Das Makroökonomische Modell} \
\label{sec:orgf0b4294}
...
\section{Konjunktur}
\label{sec:orgaf1d699}
\subparagraph{Phasen Konjunktur} \
\label{sec:orgb664446}
\begin{description}
...
\label{sec:orgff0f9b7}
\subparagraph{Inflation} \
\label{sec:orgd9cab87}
...
\section{Geld}
\label{sec:orgb7ab2c4}
\subparagraph{Was ist Geld?} \
\label{sec:org658dea6}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.4\textwidth}
    \centering
    \includegraphics[width=3in]{static/img/vwltg/geldschöpfung_overview.png}
    \caption{Geldschöpfung Überblick \label{fig:geldschöpfung-ueberblick}}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.4\textwidth}
    \centering
    \includegraphics[width=3in]{static/img/vwltg/geldmenge_m1_m2_m3.png}
