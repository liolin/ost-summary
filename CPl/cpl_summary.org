...
#+LATEX: \captionof{figure}{Manipulators}
#+LATEX: }
...
#+LATEX: \captionof{figure}{std::function example}
#+LATEX: }
...
#+LATEX: \captionof{figure}{STL Iterator Categories}
#+LATEX: }
...
#+LATEX: \captionof{figure}{The Erase-Remove Idiom}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Ranged-Based for loop}
#+LATEX: }
...
The =min= template below (\ref{fig:missingTemplate}) is implemented correctly.
...
#+LATEX: \captionof{figure}{Missing Template Overloading}\label{fig:missingTemplate}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Compiler output from pack expansion}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Accessing a member of a template parameter}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Class Template Gotchas Example}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Partial and Explicit Specialization}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Create weak_ptr from this}
#+LATEX: }
...
If you want in your subclass both members (from sub and base class) you need to /import/ using the keyword =using= (see figure \ref{fig:resoulutionShadowing}).

The output of in figure \ref{fig:shadowing} below is /Hi, I'm Base/.


#+LATEX: {
[[file:img/shadowing_member_functions.png]]
#+LATEX: \captionof{figure}{Shadowed Member Function}\label{fig:shadowing}
#+LATEX: }


#+LATEX: {
[[file:img/shadowing_member_functions_using.png]]
#+LATEX: \captionof{figure}{Resolution for Hidden Member}\label{fig:resolutionShadowing}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Virtual Member Function}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Example how to call virtual member functions}
#+LATEX: }

#+LATEX: {
[[file:img/virtual_member_function2.png]]
#+LATEX: \captionof{figure}{Example 2 how to call virtual member functions}
#+LATEX: }
...
#+LATEX: \captionof{figure}{Slicing in references}\label{fig:refslicing}
#+LATEX: }


#+LATEX: {
[[file:img/object_slicing.png]]
#+LATEX: \captionof{figure}{Example of object slicing}\label{fig:slicing}
#+LATEX: }
