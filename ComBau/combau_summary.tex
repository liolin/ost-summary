...
\section{Lexer}
\label{sec:orgf56b616}
\subparagraph{Lexer} \
\label{sec:org30fbab4}
...
\label{sec:orgb851c2a}
\subparagraph{Semantic Checker} \
\label{sec:org55ecc8b}
...
\label{sec:orga79a4bb}
\subparagraph{Code Generator} \
\label{sec:orgbee6035}
...
\label{sec:orge3ec5a4}
\subparagraph{VM} \
\label{sec:orgc208e4a}
...
\section{GC}
\label{sec:orgce57075}
\subparagraph{Dangling Pointer} \
\label{sec:org2a514cc}
...
\section{JIT}
\label{sec:orgdc16029}
\subparagraph{JIT} \
\label{sec:org4a3a6f2}
...
\label{sec:org175527c}
\subparagraph{Optimizer} \
\label{sec:org66075da}
