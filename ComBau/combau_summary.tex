...
\section{Lexer}
\label{sec:org08efbd1}
\subparagraph{Lexer} \
\label{sec:orga662acf}
...
\label{sec:org3b3fb76}
\subparagraph{Semantic Checker} \
\label{sec:org2c6a211}
...
\label{sec:org0756056}
\subparagraph{Code Generator} \
\label{sec:orgf4735aa}
...
\label{sec:orgd13bb0f}
\subparagraph{VM} \
\label{sec:orgfcccbe1}
...
\section{GC}
\label{sec:org6043a76}
\subparagraph{Dangling Pointer} \
\label{sec:org2e298a7}
