...
\section{Lexer}
\label{sec:orgfaff201}
\subparagraph{Lexer} \
\label{sec:org6b07d3e}
...
\label{sec:orgfb28b11}
\subparagraph{Semantic Checker} \
\label{sec:orgdeff75b}
...
\label{sec:orga07d3a6}
\subparagraph{Code Generator} \
\label{sec:org302d87e}
...
\label{sec:org12fc73f}
\subparagraph{VM} \
\label{sec:org855fd12}
...
\section{JIT}
\label{sec:org81dc5b7}
\subparagraph{JIT} \
\label{sec:orgab52491}
...
\label{sec:orgc40d984}
\subparagraph{Optimizer} \
\label{sec:org55d616c}
