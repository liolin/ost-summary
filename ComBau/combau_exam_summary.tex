...
\section{General}
\label{sec:org501faec}
\subparagraph{Chomsky Hierarchy} \
\label{sec:org81d3fba}
...
\section{Parser}
\label{sec:org394f8cd}
\subparagraph{Parser Categories} \
\label{sec:org707cd01}
\begin{itemize}
\item first letter
\begin{description}
...
\section{Checker}
\label{sec:org9480cc4}
\subparagraph{Symbol Table} \
\label{sec:org56eca94}
...
\section{VM}
\label{sec:orgc889292}
\subparagraph{Ancestor Table} \
\label{sec:org8ee74d6}
...
\section{GC}
\label{sec:org5b4be01}
\subparagraph{Generational GC} \
\label{sec:org9c30724}
