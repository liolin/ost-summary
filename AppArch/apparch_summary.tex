...
\label{sec:org0a6b2ae}
\subparagraph{Software Architecture} \
\label{sec:org213f47b}
...
\label{sec:org683296f}
\subparagraph{FURPS} \
\label{sec:org9c789b7}
...
\label{sec:orge3ba33d}
\subparagraph{Solution Strategy} \
\label{sec:org38c61cd}
\begin{quote}
...
\label{sec:orga5d0a72}
\subparagraph{Beans} \
\label{sec:orgeca9c7c}
...
\label{sec:orgbe8538e}
\subparagraph{INVEST} \
\label{sec:org09ea03d}
...
\section{Tactic DDD}
\label{sec:org076cac6}
\subparagraph{Domain-Driven Design} \
\label{sec:orgaf98dfc}
...
\label{sec:orgc12e26c}
\subparagraph{Business Rule} \
\label{sec:org3e8c387}
...
\section{Messaging}
\label{sec:org8ab5472}
\subparagraph{Lose Coupling} \
\label{sec:org8b93566}
...
\label{sec:orgae94e89}
\subparagraph{Service vs Components} \
\label{sec:org206dead}
...
\label{sec:orgcb96aa4}
\subparagraph{Describe API} \
\label{sec:org09a3d9c}
...
\label{sec:org77facb9}
\subparagraph{Service Granularity} \
\label{sec:orgd5f5e66}
...
\label{sec:org5bc09d1}
\subparagraph{Session State Management} \
\label{sec:org549b211}
