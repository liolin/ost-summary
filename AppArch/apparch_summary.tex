...
\label{sec:org389e4d9}
\subparagraph{Software Architecture} \
\label{sec:orgc5107a6}
...
\label{sec:org6ca5642}
\subparagraph{FURPS} \
\label{sec:org853f28e}
...
\label{sec:org8fa78cc}
\subparagraph{Solution Strategy} \
\label{sec:orgc5f00a4}
\begin{quote}
...
\label{sec:org0cdcb5b}
\subparagraph{Beans} \
\label{sec:org49ab34f}
...
\label{sec:orgeebd121}
\subparagraph{INVEST} \
\label{sec:org1030f4b}
...
\section{Tactic DDD}
\label{sec:org8e12c30}
\subparagraph{Domain-Driven Design} \
\label{sec:org4cc6b0c}
...
\label{sec:orgdd61117}
\subparagraph{Business Rule} \
\label{sec:org72f57c4}
...
\section{Messaging}
\label{sec:org16823ff}
\subparagraph{Lose Coupling} \
\label{sec:org20b7010}
...
\label{sec:org0c09273}
\subparagraph{Service vs Components} \
\label{sec:org6ada7fa}
...
\label{sec:orgfb6d0e3}
\subparagraph{Describe API} \
\label{sec:orga0d0b3c}
...
\label{sec:orgcdd8de4}
\subparagraph{Service Granularity} \
\label{sec:org6035ed5}
...
\label{sec:org15a03bb}
\subparagraph{Session State Management} \
\label{sec:org0325c2f}
