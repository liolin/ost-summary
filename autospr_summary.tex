...
\label{sec:orgb9af360}
\subsection*{Basics}
\label{sec:orga0b2e59}
...
\section*{Week 2}
\label{sec:org42c1f1b}
\subsection*{DEA (Deterministische endliche Automaten)}
\label{sec:org38e6acf}
\subsubsection*{Definition}
\label{sec:orgc0dddcf}
\begin{enumerate}
...
\label{sec:orgddcf3fd}
NEAs unterscheiden sich von \hyperref[sec:org38e6acf]{DEAs} nur geringfügig. Bei einem NEA ist es nicht notwendig, für jedes Zeichen einen Übergang zu haben. Zusätzlich können für das selbe Zeichen auch mehrere Übergänge existieren. Neben den bekannten Übergängen existieren im NEA auch \(\epsilon\)-Übergänge. Diese Übergänge können zu jeder Zeit, ohne ein Inputzeichen zu verwenden, benutzt werden.
