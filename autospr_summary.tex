...
\label{sec:org96d64b5}
\subsection*{Basics}
\label{sec:org2750f1b}
...
\section*{Week 2}
\label{sec:orgaf7ecdf}
\subsection*{DEA (Deterministische endliche Automaten)}
\label{sec:org9a3d5c7}
\subsubsection*{Definition}
\label{sec:org051887f}
\begin{enumerate}
