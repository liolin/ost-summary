...
\label{sec:org768ce93}
\subsection*{Basics}
\label{sec:org495c35a}
...
\section*{Week 2}
\label{sec:org81b6163}
\subsection*{DEA (Deterministische endliche Automaten)}
\label{sec:org39bf837}
\subsubsection*{Definition}
\label{sec:org8c86d1e}
\begin{enumerate}
...
\label{sec:org1b73a21}
NEAs unterscheiden sich von \hyperref[sec:org39bf837]{DEAs} nur geringfügig. Bei einem NEA ist es nicht notwendig, für jedes Zeichen einen Übergang zu haben. Zusätzlich können für das selbe Zeichen auch mehrere Übergänge existieren. Neben den bekannten Übergängen existieren im NEA auch \(\epsilon\)-Übergänge. Diese Übergänge können zu jeder Zeit, ohne ein Inputzeichen zu verwenden, benutzt werden.
...
\label{sec:org61b87b2}
\begin{quote}
SAT ist NP-vollständig.
\end{quote}

\section*{Week 12\hfill{}\textsc{empty}}
\label{sec:org63773b5}
\begin{itemize}
...
\label{sec:org0632a10}
\subsubsection*{SAT}
\label{sec:org6a22583}
Eine logische Formel welche wahr werden muss.
\subsubsection*{CLIQUE}
\label{sec:orgc0f0c15}
