...
[[file:img/dot_net_architektur.png]]
...
[[file:img/ref_type_stack_heap.png]]
...
[[file:img/naming_guidelines.png]]

#+NAME: fig:visibility
[[file:img/sichtbarkeitsattribute.png]]
...
[[file:img/main_methods_example.png]]
...
[[file:img/array_memory_layout.png]]
...
[[file:img/initialisierungsreihenfolge.png]]
...
[[file:img/multicast_delegate_implementation.png]]
...
[[file:img/closures_how_does_it_work.png]]
...
[[file:img/exception_with_multicast.png]]
...
The most prominent application for reflection is /Intelli Sense/ or the /Object Browser/ in Visual Studio.
...
All types in the [[id:e2426813-87a6-4079-95f4-9d4a2d487846][CLR]] are self defined using =System.Type=.
The =System.Type= is the entry point for all reflection operations.
The =System.Type= class describes itself with an =System.Type= instance.
The base class for =System.Type= is the =System.RuntimeType=.

*Runtime Prefix*

The prefix /Runtime/ in .NET means that this class is only instanced only once.
For example the =System.RuntimeType=.
...
#+NAME: fig:type-hierarchy-in-reflection
[[file:img/type_hierarchy_reflection.png]]
...
The method info inherits from =MethodBase= and describes a method of a class.
This includes the:
- name
...
The constructor info inherits from =MethodBase= and describes a constructor of a class.
This includes:
- name
- parameters
- visibility
...
Attributes are the same thing like annotations in [[id:d4e5f169-81a7-4ce9-a0ff-e85399b1294a][Java]].
...
in [[id:95b391d4-12b4-4143-89c8-6bdde15489f1][.NET]] exists two kind of attributes:
- /intrinsic/: in the [[id:e2426813-87a6-4079-95f4-9d4a2d487846][CLR]] defined and integrated
...
Your attribute must inherit from =System.Attribute= and must have the suffix =Attribute=.
Additionaly it must use the attribute =AttributeUsage=.
The =AllowMultiple= is per default set to =false=.
