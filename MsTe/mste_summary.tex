...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{static/img/mste/multicast_delegate_implementation.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{static/img/mste/closures_how_does_it_work.png}
...
\lstset{language=csharp,label= ,caption={The ?? operator},captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{static/img/mste/exception_with_multicast.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{static/img/mste/async_vs_concurrent.png}
