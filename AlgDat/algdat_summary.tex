...
\caption{\label{fig:org9d09601}Quick Sort Tree}
\end{figure}
...
\caption{\label{fig:org8f38d2d}BFS Example}
\end{figure}
...
\caption{\label{fig:orgfb49a20}DFS vs. BFS}
\end{figure}

\subparagraph{Floyd-Warshall} \
\label{sec:org93c1174}
