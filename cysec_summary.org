...
#+LATEX_HEADER: \pagestyle{fancy} %eigener Seitenstil
#+LATEX_HEADER: \fancyhf{} %alle Kopf- und Fußzeilenfelder bereinigen
#+LATEX_HEADER: \fancyhead[L]{CySec FS2021} %Kopfzeile links
#+LATEX_HEADER: \fancyhead[C]{} %zentrierte Kopfzeile
#+LATEX_HEADER: \fancyhead[R]{Olivier Lischer} %Kopfzeile rechts
#+LATEX_HEADER: \renewcommand{\headrulewidth}{0.4pt} %obere Trennlinie
#+LATEX_HEADER: \fancyfoot[C]{\thepage} %Seitennummer
#+LATEX_HEADER: \renewcommand{\footrulewidth}{0.4pt} %untere Trennlinie
...
** CIA triad
[[file:static/img/cysec/cia_triad.png]]
...
[[file:static/img/cysec/risk_terminology.png]]
...
[[file:static/img/cysec/quantitative_risk_analysis.png]]
...
[[file:static/img/cysec/primary_access_control_types.png]]
...
[[file:static/img/cysec/other_access_control_types.png]]
...
[[file:static/img/cysec/steps_of_access_control.png]]
...
[[file:static/img/cysec/aes_network.png]]
...
- *Cipher Block Chaining (CBC)*
  ...
  - betterthan ECB
    ...
    [[file:static/img/cysec/cbc_mode.png]]
...
- *Counter Mode (CTR)*
  ...
  - convert block cipher into a stream
    ...
    [[file:static/img/cysec/ctr_mode.png]]
...
[[file:static/img/cysec/hash_loop_function.png]]
...
[[file:static/img/cysec/hmac.png]]
...
*** SSL / TLS Attacks
[[file:static/img/cysec/ssl_tls_attacks.png]]
...
- *CA / Browser Forum (CA / B)*
  [[file:static/img/cysec/ca_b.png]]
...
- *Inter-Realm Authentication*
  [[file:static/img/cysec/inter_realm_authentication.png]]
...
- using this DH secret a mutual Challenge / Response is built
  ...
  [[file:static/img/cysec/encrypted_key_exchange.png]]

*** Summary
[[file:static/img/cysec/vulnerability_matrix.png]]
...
- penetration testing methodologies
  [[file:static/img/cysec/penetration_testing_methodologies.png]]

  [[file:static/img/cysec/penetration_testing_methodologies_ec.png]]
...
[[file:static/img/cysec/shibboleth.png]]
...
[[file:static/img/cysec/oauth2_protocol_flow.png]]
...
[[file:static/img/cysec/vulnerability_management_steps.png]]
...
[[file:static/img/cysec/phases_of_digital_forensics.png]]

Threat and incident management best practice
1. Cybersecurity resilience (en für Belastbarkeit): Technical vulnerability management, Security event logging, Security event management, Threat intelligence, Cyber attack protection
